"""The one seed in scope for P1/P2: "supplier milestone variation" (original design notes).
...
The other 3 seeds from the original design notes (budget overrun, resourcing
